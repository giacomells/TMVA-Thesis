...
output = TFile.Open('TMVA_Classification_General.root', 'RECREATE')
...
factory.BookMethod(dataloader, ROOT.TMVA.Types.kMLP, "MLP",
                   "H:!V:NeuronType=tanh:VarTransform=N:NCycles=500:HiddenLayers=N+5:TestRate=5")
factory.BookMethod(dataloader, TMVA.Types.kDL, "DL",
                   "H:!V:VarTransform=N:Architecture=CPU:Layout=TANH|128,TANH|128,TANH|128,LINEAR")
